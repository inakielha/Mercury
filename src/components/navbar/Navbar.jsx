...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={scroll ? style.navbar: style.navbarNoScroll} >
      {/* <nav className={style.navbar} style={scroll ? {height:"12vh" ,boxShadow:"0px 2px 4px #FF3A2D"}:{}}> */}
        <div className={style.container} style={scroll ? { display:"none"}:{}}>
