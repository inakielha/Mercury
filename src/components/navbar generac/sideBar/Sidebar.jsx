...
export default function Sidebar({ open, close }) {
    ...
    const list = () => (
        <div className={s.container}>
            ...
            <div className={s.tituloText} onClick={() => window.open("https://www.navalmotor.com/", "_blank")}>INCIO</div>
            <div className={s.tituloText} onClick={() => window.open("https://www.navalmotor.com/novedades", "_blank")}>NOVEDADES</div>
            ...
            <div className={s.tituloText} onClick={() => window.location.href = "https://www.navalmotor.com/la-empresa"}>LA EMPRESA</div>
            <div className={s.tituloText} onClick={() => window.location.href = "https://www.navalmotor.com/contacto/general"}>CONTACTO</div>
        </div>
